...
def add_part(part_name, vendor_list):
    """
    Функция вставляет данные в две таблици parts и vendors_parts
    :param part_name:
    :param vendor_list:
    """
...
if __name__ == '__main__':
    ...
    # эти данные не будут созданы. Так как, 99 id нет в таблице vendors
    add_part('SIM Tray', (1, 2, 4, 5, 6, 8, 99))
